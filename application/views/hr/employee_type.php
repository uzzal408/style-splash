            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           <input name="designation" class="form-control" type="text" placeholder="<?php echo display('designation') ?>" id="designation" value="<?php echo html_escape((!empty($designation_data[0]['designation'])?$designation_data[0]['designation']:''))?>"> 
