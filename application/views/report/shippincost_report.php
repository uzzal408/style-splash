                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('shipping_cost_report'); ?> </h4>
                        </div>
                    </div>
                    <div class="panel-body">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo display('shipping_cost')?><?php echo form_open('Admin_dashboard/retrieve_dateWise_Shippingcost', array('class' => 'form-inline', 'method' => 'get')) ?>
