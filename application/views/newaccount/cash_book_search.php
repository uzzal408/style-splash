    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            <div class="panel-body">
                ...
                <div class="">
                    <table width="100%" class="table_boxnew" cellpadding="6" cellspacing="1">
                        <tr>
                        <tr align="center">
                            <td colspan="7"><font size="+1"> <strong><?php echo display('cash_book_report_on')?> <?php echo $FromDate; ?> <?php echo display('to')?> <?php echo $ToDate;?></strong></font><strong>
                            </th>
                            </strong></tr>
                        ...
                        <tr>
                            <td colspan="7">
                                <div id="print" align="center">
                                    <div class="login_input">
                                        <div class="login_submit">
                                            <input type="button" name="btnPrint" id="btnPrint" value="Print"  onclick="btnPrint();"/>
                                        </div>
                                        <div class="login_submit"><input type="button" name="btnBack" id="btnBack" value="Back" onclick="window.history.back();"/></div>
                                    </div>
                                </div>
                                ...
                                <div id="back" align="center">
                                    <div class="login_input">
                                        <div class="login_submit">
                                            <a href="?Acc=CB" name="btnBack" id="btnBack" >Back</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
