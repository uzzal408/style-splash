    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <a href="<?php echo base_url('Cloan/add_ofloan_person') ?>" class="btn btn-warning m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_person') ?> </a>
                    <a href="<?php echo base_url('Cloan/manage_ofln_person') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('manage_person') ?> </a>
