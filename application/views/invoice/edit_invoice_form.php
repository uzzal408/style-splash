                             ...
                             <div class="col-sm-6" id="payment_from_1">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <option value="3" <?php if ($paytype == 3) {
                                                echo 'selected';
                                            } ?>>Bkash Payment
                                            </option>
                                            <option value="4" <?php if ($paytype == 4) {
                                                echo 'selected';
                                            } ?>>Nagad Payment
                                            </option>
                                            <option value="5" <?php if ($paytype == 5) {
                                                echo 'selected';
                                            } ?>>Credit Card Payment
                                            </option>
                                            <option value="6" <?php if ($paytype == 6) {
                                                echo 'selected';
                                            } ?>>DBBL Payment
                                            </option>
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <select name="shipping_method" id="">
                                            ...
                                            <option value="1" <?php if ($shippingMethod == 1): ?> selected <?php endif; ?>>
                                                Redx
                                            </option>
                                            <option value="2" <?php if ($shippingMethod == 2): ?> selected <?php endif; ?>>
                                                Pathao
                                            </option>
                                            <option value="3" <?php if ($shippingMethod == 3): ?> selected <?php endif; ?>>
                                                Sundorban
                                            </option>
                                            <option value="4" <?php if ($shippingMethod == 4): ?> selected <?php endif; ?>>
                                                SA Poribahon
                                            </option>
                                            <option value="5" <?php if ($shippingMethod == 5): ?> selected <?php endif; ?>>
                                                Showroom
                                            </option>
