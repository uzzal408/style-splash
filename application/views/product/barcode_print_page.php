                                            ...
                                            <?php if ($counter == $cqty) { ?>
                                                ...
                                                <td class="barcode-toptd">      
                                                    ...
                                                    <div class="barcode-inner barcode-innerdiv">
                                                        ...
                                                        <img src="<?php echo base_url('Cbarcode/barcode_generator/{product_id}') ?>"  alt="">
<!--                                                        <img src="--><?php //echo base_url('Cbarcode/barcode_generator/{product_id}') ?><!--" class="img-responsive center-block barcode-image" alt="" style="display: none" >-->
