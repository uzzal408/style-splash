                        ...
                        <div class="row">
                            <div class="col-sm-6" id="payment_from_1">
                                <div class="form-group row">
                                    <label for="product_name" class="col-sm-4 col-form-label"><?php echo display('customer_mobile') ?> <i class="text-danger"></i></label>
                                    <div class="col-sm-8">
                                        <input type="text" name="customer_mobile" value="{customer_mobile}" class="form-control customerSelection" placeholder='<?php echo display('customer_mobile') ?>' required id="customer_mobile" tabindex="1" readonly="">
