                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <td class="text-center"><?php echo html_escape($services['details']);?></td>
                                    ...
                                    <?php }?>
                                     <a href="<?php echo base_url() . 'Cservice/servicedetails_download/'.$services['voucher_no']; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('download') ?>"><i class="fa fa-download" aria-hidden="true"></i></a>
