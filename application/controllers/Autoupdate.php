...
//Get Update file
define('MIN_VERSION', file_get_contents('http://update.bdtask.com/saleserp/autoupdate/update_min_version'));
//Get Update file
define('MAX_VERSION', file_get_contents('http://update.bdtask.com/saleserp/autoupdate/update_max_version'));

//Get Update file
define('UPDATE_URL','http://update.bdtask.com/saleserp/autoupdate');
// Get latest version info
define('UPDATE_INFO_URL','http://update.bdtask.com/saleserp/autoupdate/update_info');
// CRM temporary path
...
class Autoupdate extends CI_Controller
{
    ...
    public function index(){ 
        ...
        $content = $this->parser->parse('backend/autoupdate/autoupdate',$data,true);
